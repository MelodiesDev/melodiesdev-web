...
import { ConstellationData, SkyCultureData, Star } from "./Types";
...
const ConstellationLinesRenderer: FC<{ stars: Star[]; constellationLinesData: ConstellationData[] }> = ({
                                                                                                          stars,
                                                                                                          constellationLinesData
                                                                                                        }) => {
  ...
  useEffect(() => {
    ...
    if (Math.abs(lineOfSightWorld.dot(cameraUpForSetLookAt)) > 0.999) {
      if (Math.abs(lineOfSightWorld.y) > 0.9) {
        cameraUpForSetLookAt.set(1, 0, 0);
      } else {
        cameraUpForSetLookAt.set(0, 1, 0);
      }
      if (Math.abs(lineOfSightWorld.dot(cameraUpForSetLookAt)) > 0.999) {
        cameraUpForSetLookAt.set(0, 0, 1);
      }
    }
