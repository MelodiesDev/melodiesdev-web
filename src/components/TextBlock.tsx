...
export function TextBlock({
  ...
  return (
    <Glow color="white" debug={false} style={{}} className="">
      <a
        href={href}
        className="flex flex-col m-1 rounded-2xl bg-gradient-to-b from-[#864DFF]/80 to-[#339DE9]/80 p-4 outline-glow glow:bg-glow glow:outline glow:outline-white"
      >
        <div className="flex flex-row justify-between">
          <div className="text-2xl font-semibold text-[#EAE2FF]">{header}</div>
